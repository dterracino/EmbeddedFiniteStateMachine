...
#define EFSM_DEBUG_INTERFACE_FILES_FILENAME_BUFFER_SIZE									500
#define EFSM_DEBUG_INTERFACE_EMBEDDED_STATUS_TRANSMIT_FILE								debugStatusTxFilename
#define EFSM_DEBUG_INTERFACE_EMBEDDED_COMMAND_RECEIVE_FILE								debugCommandRxFilename
...
extern char debugStatusTxFilename[EFSM_DEBUG_INTERFACE_FILES_FILENAME_BUFFER_SIZE];
extern char debugCommandRxFilename[EFSM_DEBUG_INTERFACE_FILES_FILENAME_BUFFER_SIZE];
